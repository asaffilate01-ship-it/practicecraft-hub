...
export const regulatoryReadiness: ReadinessModule[] = [
  ...
  { key: "accounts-production", name: "Accounts preparation and final accounts", authority: "Internal", status: "beta", current: "Trial balance, journals, FRS 105/FRS 102 Section 1A preparation controls, comparatives, rounding and independent reviewer locks are implemented.", next: "Complete formal content evaluation, groups/consolidation, final PDF generation and current-taxonomy iXBRL validation.", route: "/accounts", phase: 2 },

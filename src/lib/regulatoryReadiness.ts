...
export const regulatoryReadiness: ReadinessModule[] = [
  ...
  { key: "accounts-production", name: "Accounts preparation and final accounts", authority: "Internal", status: "beta", current: "Trial balance, journals, FRS 105/FRS 102 Section 1A controls, comparatives, rounding, reviewer locks and versioned tagged-fact snapshots are implemented.", next: "Complete formal content evaluation, groups/consolidation, final PDF generation and external iXBRL validation.", route: "/accounts", phase: 2 },
  ...
  { key: "company-accounts", name: "Companies House annual accounts", authority: "Companies House", status: "build", current: "FRC 2026 release control, locked-source package versions, deterministic preflight, mapping coverage, two-person tagged-facts review and server-only validator/test evidence controls are implemented.", next: "Build the standards-conformant XHTML/iXBRL renderer, add rendered-document visual review, run Accounts TIS 5.9 validation and obtain Companies House test-service acceptance.", route: "/ixbrl", phase: 2, integrationKeys: ["companies-house-xml-gateway"] },

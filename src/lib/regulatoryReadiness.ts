...
export interface ReadinessModule {
  name: string;
  authority: "Internal" | "HMRC" | "Companies House";
...
export const regulatoryReadiness: ReadinessModule[] = [
  ...
  { name: "Record ingestion and accounts AI", authority: "Internal", status: "beta", current: "Bank/CSV/PDF ingestion, fingerprints, duplicate/match review, capex suggestions, judgements and year-end checklist exist.", next: "Deploy migrations/functions, add OCR confidence QA, deterministic posting controls and accountant-labelled evaluation sets.", route: "/accounts-intelligence", phase: 1 },

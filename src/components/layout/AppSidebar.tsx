...
const mainNav = [
  ...
  { title: "VAT (MTD)", url: "/vat", icon: Receipt },
  { title: "Payroll (RTI)", url: "/payroll", icon: Wallet },
  { title: "Accounts", url: "/accounts", icon: FileText },
  { title: "Secretarial", url: "/secretarial", icon: Building2 },
  { title: "AML / KYC", url: "/kyc", icon: ShieldCheck },
